...
public class BluetoothServerService {
	...
	public static BluetoothServerService getInstance(Context ctx, Handler hld) {
		if(instance == null) {
			instance = new BluetoothServerService(ctx, hld);
		}
		else {
			instance.updateHandler(hld);
		}
     ...
     */
    private BluetoothServerService(Context context, Handler handler) {
    ...
    public synchronized void start() {
    	if (mState == STATE_SHUTDOWN) {
    		Log.d(TAG, "BluetoothServerService.start skipped.");
    		return;
    	}
